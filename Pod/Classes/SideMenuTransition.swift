...
open class SideMenuTransition: UIPercentDrivenInteractiveTransition {
    ...
    @objc internal class func handlePresentMenuPan(_ pan: UIPanGestureRecognizer) {
        ...
        if !singleton.interactive {
            ...
            if let menuViewController = viewControllerForMenu {
                if let presentingViewController = presentingViewControllerForMenu != nil ? presentingViewControllerForMenu! : visibleViewController {
    ...
    @objc internal func handleNotification(notification: NSNotification) {
        //TODO: not sure how this is affected by the modified SideMenuTransition.presentingViewControllerForMenu
